...
<div id="chart_div" style="width: 650px; height: 400px;"></div>
                      ...
                      <% try{
                   	   ...
                   	   { %><script>
                   	   function Send(frm){
                			  frm.action="00_test.jsp?chex=Activity&chex=Machine&chex=Frequency&chex=Bar+Chart";
                			  frm.method="post";
                			  frm.submit();
                		  }
                		  </script>
...
<div id="chart_div" style="width: 900px; height: 380px;"></div>
                    	   ...
                    	   {   %><script>
                    	   function Send(frm){
                    			  frm.action="00_test.jsp?chex=Activity&chex=Machine&chex=Frequency&chex=Pie+Chart";
                    			  frm.method="post";
                    			  frm.submit();
                    		  }
                    		  </script>
...
<div id="piechart" style="width: 900px; height: 380px;"></div>
                    	   ...
                    	   {%><script>
                    	   function Send(frm){
                 			  frm.action="00_test.jsp?chex=Activity&chex=Machine&chex=Frequency&chex=Line+Chart";
                 			  frm.method="post";
                 			  frm.submit();
                 		  }
                 		  </script>
...
<div id="chart_div" style="width: 900px; height: 380px;"></div>
            ...
            <%--     <div class="col-lg-3">
					<div class="panel panel-default">
						<div class="panel-heading"><strong>Case ID</strong></div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<form></form>
							<div class="panel-body ">
				...
				<div class="col-lg-3">
					<div class="panel panel-default">
						<div class="panel-heading"><strong>Machine</strong></div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<form></form>
							<div class="panel-body ">
