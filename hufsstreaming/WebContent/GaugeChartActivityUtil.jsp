...
<body>
	...
	String time = "time";
									...
									try {
										...
										String query_str7 = "select caseid, activity, machine, time from "+Database+" ";
										...
										String q7 = "Select distinct activity from "+Database+" "; // q 에 엑티비티들을 따온다
										...
										String q27 = "Select TIMESTAMPDIFF(SECOND,MIN(STR_TO_DATE(time,'%d/%m/%Y %h:%i:%s')),MAX(STR_TO_DATE(time,'%d/%m/%Y %h:%i:%s'))) AS TotalactTime FROM "+Database+" ";
										...
										for (int j7 = 0; j7 < check.length; j7++) {
											...
											query_str17 += "FROM    "+Database+" as a ";

											query_str17 += "LEFT JOIN "+Database+" as b ";
											...
											int countNum7 = 0;
											String q57 = "Select time from "+Database+" where activity = '"
													+ check[j7] + "'";
